  ...
  return (
    <>
      ...
      <div className="br-visual-block br-br">
        ...
        <div className="br-product float-fast" style={{ backgroundImage: 'url(/assets/images/fg_nike.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'right bottom', width: '100%', height: '100%' }} />
      </div>
    </>
  )
}
...
export default function BrandingPage() {
  ...
  return (
    <div className="brand-page-v2" style={s.slideStyle || {}}>
      <Navbar />
      ...
      {s.bgVideo ? (
        <video 
          ...
          loop 
          playsInline
          className={`br-bg-layer ${current === current ? 'br-bg-active' : ''}`}
          style={{ width: '100%', height: '100%', objectFit: 'cover', ...s.bgStyle }}
        />
      ) : s.bg ? (
        <div className={`br-bg-layer ${current === current ? 'br-bg-active' : ''}`}
          style={{ backgroundImage: s.bg, ...s.bgStyle }} />
      ) : null}

      {/* Slide Content */}
      <div className={`br-slide-content ${transitioning ? 'br-slide-out' : 'br-slide-in'}`}>
